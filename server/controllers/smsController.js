...
function sendSMS(Email, otp) {
    ...
    let mailOptions = {
        ...
        to: Email,
        subject: "One Time Password - EventEase",
        html: `Please keep your OTP confidential and do not share it with anyone. The OTP will be valid for five minutes only. <br><strong>OTP: ${otp}</strong><br><br>Thank you for choosing EventEase!<br><br>If you have any questions, please contact us at:<br>Nxtgencat: nxtgencat.in@gmail.com`
    };
